In this assignment i implemented the multithread operations of the put and get commands,
provided by the Kiwi storage engine, written in C and based on the Linux Pthreads library.
